...
$temporary_directory = "/usr/local/uebimiau/";
...
$smtp_server = "drurylawnmaintenance.com";  
...
$mail_servers[] = Array( //sample using POP3
	"domain" 		=> "drurylawnmaintenance.com", 
	"server" 		=> "drurylawnmaintenance.com", 
